          ...
          <div class="col-sm-12 col-lg-10">
            <div class="dashboard-inner">
              <div class="row back-to-home">
                <div class="breadcumb">
                  <ul>
                    <li><a href="mydreamhome.html"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back to My
                        Dream Home</a></li>
                  </ul>
                </div>
              </div>
                      ...
                      <div class="row">
                        <div class="col-sm-12 col-lg-4">
                          ...
                          <div class="float-left">
                            <h3 class="apartment-name2"><a href="#"> Nacary Apartment</a></h3>
                              ...
                              <div class="row">
                                ...
                                <!-- <div class="col-lg-12">
                                  <div class="progress-line">
                                    <ul>
                                      <li class="progress-1"><a href="mydreamhome-details-phase-a.html"><img
                                            src="images/white-prgress=arrow.png"></a> <span>Phase A</span></li>
                                      <li class="progress-2"><img src="images/white-prgress=arrow.png"> <span>Phase
                                          B</span>
                                      </li>
                                      <li class="progress-3"><img src="images/white-prgress=arrow.png"> <span>Phase
                                          C</span>
                                      </li>
                                      <li class="progress-4"><img src="images/white-prgress=arrow.png"> <span>Phase
                                          D</span>
                                      </li>
                                      <li class="progress-5"><img src="images/white-prgress=arrow.png"> <span>Phase
                                          E</span>
                                      </li>
                                      <li class="progress-6"><img src="images/white-prgress=arrow.png"> <span>Phase
                                          F</span>
                                      </li>
                                    </ul>
                                  </div>
