              ...
              <form action="#" class="form form-section">
                <div class="row">
                  <div class="col-sm-12 col-lg-6">
                    <p>Do you need a work permit to be employed in the UK?</p>
                  </div>
                  ...
                  <div class="col-sm-12 col-lg-4">
                    <div class="note-sec">
                      <p>*Note: you will be asked to provide a basic CRB check if appointed</p>
                    </div>

                  </div>
                  <div class="col-sm-12 col-lg-6">
                    <p>Do you hold a current UK driving licence?
                    </p>
                  </div>
                  <div class="col-sm-12 col-lg-2">
                    <label class="radio-inline">
                ...
                <div class="col-sm-12 col-lg-12">
                  <div class="input-box-size">
                    <input type="text" class="form-control text-field-size " id="" name="" placeholder="Please give details of any point/convictions
                  ">
                  </div>
                </div>
              </div>
                <div class="row">
                  <div class="col-sm-5 col-lg-6">
                    <div class="input-box-size-fix3">
                      <input type="text" class="form-control text-field-size " id="" placeholder="Professional Body"
                        name="professionalbody">
                    </div>
                  </div>
                  <div class="col-sm-5 col-lg-5">
                    <div class="input-box-size-fix3">
                      <input type="date" class="form-control date-field-size " id="" placeholder="End date"
                        name="endDate">
                    </div>
                  </div>
                  <div class="col-sm-2 col-lg-1">
                    <div class="">
                      <a href="#" class="btn signup-professional-plus-btn"><i class="fa fa-plus"></i></a>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-5 col-lg-6">
                    <div class="input-box-size-fix3">
                      <input type="text" class="form-control text-field-size " id=""
                        placeholder="Professional Body Membership No." name="startDate">
                    </div>
                  </div>
                  <div class="col-sm-5 col-lg-5">
                    <div class="input-box-size-fix3">
                      <input type="date" class="form-control date-field-size " id="" placeholder="endDate"
                        name="endDate">
                    </div>
                  </div>
                  <div class="col-sm-2 col-lg-1">
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix3">
                      <input type="text" class="form-control text-field-size" id=""
                        placeholder="Other relevant Qualifications" name="">
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-6 col-sm-6 col-lg-6">
                    <div class="prev-btn float-left">
                      <a href="signup-professionals-profile.html" class="btn previous-btn" style="width: 164px; ">
                        PREVIOUS</a>
                    </div>
                  </div>
                  ...
                  <div class="col-6 col-sm-6 col-lg-6">
                    <div class="prev-btn float-right">
                      <a href="signup-professionals-profile-3.html" class="btn btn-next" style="width: 164px; ">
                        NEXT</a>
                    </div>
              </form>
            </div>
