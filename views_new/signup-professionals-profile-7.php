                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-5">
                    <div class="input-box-size-fix3">
                      <select class="form-control " class="text-field-size" id="selectBox">
                  ...
                  <div class="col-sm-12 col-lg-5">
                    <div class="input-box-size-fix3">
                      ...
                      <select class="form-control " class="text-field-size" id="selectBox">
                        <option value="0">Select Language Proficiency Level</option>
                  ...
                  <div class="col-sm-12 col-lg-1">
                    <div class="add-btn">
                      <a href="#" class="btn signup-professional7-add-btn"><i class="fa fa-plus"></i></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-6 col-sm-6 col-lg-6">
                    <div class="prev-btn-fix2 float-left">
                      <a href="signup-professionals-profile-6.html" class="btn previous-btn" style="width: 164px; ">
                        PREVIOUS</a>
                    </div>
                  </div>
                  ...
                  <div class="col-6 col-sm-6 col-lg-6">
                    <div class="prev-btn-fix2 float-right">
                      <a href="portfolio.html" class="btn btn-next" style="width: 164px;">
                        NEXT</a>
                    </div>
                  </div>
