              ...
              <form action="#" class="form form-section">
                ...
                <div class="col-sm-12 col-lg-12">
                  <div class="input-box-size">
                    <input type="text" class="form-control text-field" id="" placeholder="Address" name="address">
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix3">
                      <input type="text" class="form-control text-field-size " id=""
                        placeholder="Relationship(One must be work related)" name="relationship">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-6 col-sm-6 col-lg-6">
                    <div class="prev-btn float-left">
                      <a href="signup-professionals-profile-4.html" class="btn previous-btn" style="width: 164px; ">
                        PREVIOUS</a>
                    </div>
                  </div>
                  ...
                  <div class="col-6 col-sm-6 col-lg-6">
                    <div class="prev-btn float-right">
                      <a href="signup-professionals-profile-6.html" class="btn btn-next" style="width: 164px;">
                        NEXT</a>
                    </div>
              </form>
            </div>
