    ...
    <nav class="navbar navbar-expand-lg d-block d-xs-none d-lg-none">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="property-detail.html"><img class="act-img" src="images/dreamhome-active.png"><img
        ...
        <div class="row content">
          <div class="col-sm-3 sidenav2 hidden-xs-down">
            ...
            <ul class="dashboard-nav">
              ...
              <li class="completed">
                <a href="signup-professionals-profile-4.html">
                  <img class="complete-img" src="images/checked.png">
                  <img class="act-img" src="images/4-active.png">
                  <img src="images/4.png"> EMPLOYMENT HISTORY</a>
              </li>
              <li class="completed">
                <a href="signup-professionals-profile-5.html">
                  <img class="complete-img" src="images/checked.png">
                  <img class="act-img" src="images/5-active.png">
                  <img src="images/5.png"> REFERENCES</a>
              </li>
              <li class="active">
              ...
              <form action="#" class="form form-section">
                ...
                <div class="col-sm-12 col-lg-12">
                  <div class="input-box-size">
                    <input type="text" class="form-control text-field" id="" placeholder="" name="">
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix3">
                      <input type="text" class="form-control text-field-size " id="" placeholder="Name of Insurer"
                        name="insurerName">
                    </div>
                  </div>
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix3">
                      <input type="text" class="form-control text-field-size " id=""
                        placeholder="Broker Details(if applicable)" name="brokerDetails">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix3">
                      <input type="text" class="form-control text-field-size " id="" placeholder="Level of cover"
                        name="levelofcover">
                    </div>
                  </div>
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix3">
                      <input type="date" class="form-control text-field-size " id="" placeholder="Renewal Date"
                        name="renewalDate">
                    </div>
                  </div>
                </div>
                ...
                <div class="row btn-sec">
                  <div class="col-6 col-sm-6 col-lg-6">
                    <div class="prev-btn-fix float-left">
                      <a href="signup-professionals-profile-5.html" class="btn previous-btn" style="width: 164px; ">
                        PREVIOUS</a>
                    </div>
                  </div>
                  ...
                  <div class="col-6 col-sm-6 col-lg-6">
                    <div class="prev-btn-fix float-right">
                      <a href="signup-professionals-profile-7.html" class="btn btn-next" style="width: 164px;">
                        NEXT</a>
                    </div>
                  </div>
