        ...
        <div class="row content">
          <div class="col-sm-2 sidenav hidden-xs-down">
            ...
            <ul class="dashboard-nav">
              ...
              <li>
                <a href="mydreamhome-details.html"><img class="act-img" src="images/dreamhome-active.png"><img
          ...
          <div class="col-sm-12 col-lg-10">
            ...
            <!-- <div class="row">
                <div class="breadcumb">
                  <ul>
                    <li><a href="dashboard.html"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back to Nacary
                        Apartment</a></li>
                  </ul>
                </div>
              </div> -->
                    ...
                    <div class="docs-files">
                      <div class="clearfix">
                        <div class="float-left">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu ">
                              <a class="dropdown-item item1" href="professionals.html"><span><img src="images/tick.png"
                                    alt=""></span>&nbsp;All Professionals</a>
                              <hr class="divider" />
                              <a class="dropdown-item item2" href="myprofessionals.html"><span><img
                                    src="images/tick.png" alt=""></span> My professionals</a>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="professional-right-sec">
                            ...
                            <div class="dropdown">
                            <button class="btn professional-search-btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              Show Filters
                            </button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item active" href="#">Qualification</a>
                      ...
                      <div class="col-sm-12 col-lg-12">
                        <ul class="icon-list">
                          <li><a href="#"><img src="images/accountant.png" alt="" title=""><br><span>Accountants
                              </span></a>
                          </li>
                          <li><a href="#"><img src="images/architect.png" alt=""
                                title=""><br><span>Architects</span></a>
                          </li>
                          <li><a href="#"><img src="images/developers.png" alt="" title=""><br><span>Developers
                              </span></a></li>
                          <li><a href="#"><img src="images/engineer.png" alt="" title=""><br><span>Engineers </span></a>
                          </li>
                          <li><a href="#"><img src="images/financial-advisors.png" alt="" title=""><br><span>Financial
                                Advisors
                              </span></a></li>
                          <li><a href="#"><img src="images/interior-designers.png" alt="" title=""><br><span>Interior
                                Designers
                              </span></a>
                          </li>
                          <li><a href="#"><img src="images/lawyers.png" alt="" title=""><br><span>Lawyers/
                                Conveyancers</span></a>
                          </li>
                          <li><a href="#"><img src="images/mortgage-broker.png" alt="" title=""><br><span>Mortgage
                                Brokers</span></a>
                          </li>
                          <li><a href="#"><img src="images/surveyors.png" alt="" title=""><br><span>Surveyors
                              </span></a>
                          </li>
                          <li style="margin-right:0px"><a href="#"><img src="images/valuers.png" alt=""
                                title=""><br><span>Valuers</span></a>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div class="row">
                  ...
                  <div class="card card-fix2">
                    <div class="row">
                      <div class="float-left card-header-fix">
                        <a href="professionals-detail.html"> <img class="card-img-top" src="images/recent-user-1.png"
                            alt="Card image cap"></a>
                      </div>
                      <div class="float-right card-content-fix">
                        <a href="professionals-detail.html">
                          <h5>Alex Jackson</h5>
                        </a>
                        <p>Architect</p>
                      </div>
                    ...
                    <div class="card-body">
                      <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed dLorem ipsum
                        dolor sit</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="card card-fix2">
                    <div class="row">
                      <div class="float-left card-header-fix">
                        <a href="professionals-detail.html"> <img class="card-img-top" src="images/recent-user-2.png"
                            alt="Card image cap"> </a>
                      </div>
                      <div class="float-right card-content-fix">
                        <h5>Alex Jackson</h5>
                ...
                <div class="col-lg-3">
                  <div class="card card-fix2">
                    <div class="row">
                      <div class="float-left card-header-fix">
                        <a href="professionals-detail.html"> <img class="card-img-top" src="images/recent-user-3.png"
                            alt="Card image cap"> </a>
                      </div>
                      <div class="float-right card-content-fix">
                        <h5>Alex Jackson</h5>
