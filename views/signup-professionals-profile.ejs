      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link" href="signup-professionals-profile.html"><img class="act-img"
                src="images/1-active.png"><img src="images/1.png">PERSONAL DETAILS </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="signup-professionals-profile-2.html"><img class="act-img"
                src="images/2-active.png"><img src="images/2.png"> OTHER DETAILS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="signup-professionals-profile-3.html"><img class="act-img"
                src="images/3-active.png"><img src="images/3.png"> EDUCATION</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="signup-professionals-profile-4.html"><img class="act-img"
                src="images/4-active.png"><img src="images/4.png"> EMPLOYMENT HISTORY</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="signup-professionals-profile-5.html"><img class="act-img"
                src="images/5-active.png"><img src="images/5.png"> REFERENCES</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="signup-professionals-profile-6.html"><img class="act-img"
                src="images/6-active.png"><img src="images/6.png"> PROFESSIONAL INDEMNITY
              INSURANCE</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="signup-professionals-profile-7.html"><img class="act-img"
        ...
        <div class="row content">
          <div class="col-sm-3 sidenav2 hidden-xs-down">
            ...
            <ul class="dashboard-nav">
              <li class="active">
                <a href="signup-professionals-profile.html"><img class="act-img" src="images/1-active.png"><img
                    src="images/1.png">PERSONAL DETAILS </a>
              </li>
              <li>
                <a href="signup-professionals-profile-2.html"><img class="act-img" src="images/2-active.png"><img
                    src="images/2.png"> OTHER DETAILS</a>
              </li>
              <li>
                <a href="signup-professionals-profile-3.html"><img class="act-img" src="images/3-active.png"><img
            ...
            <div class=" dashboard-inner">
              ...
              <form action="#" class="form form-section">
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix">
                      <input type="text" class="form-control text-field-size " id="" placeholder="Surname"
                        name="surname">
                    </div>
                  </div>
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix">
                      <input type="text" class="form-control text-field-size " id="" placeholder="Forenames"
                        name="forenames">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix">
                      <select class="form-control " id="selectBox2">
                        <option value="0">Preferred Title</option>
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix">
                      <input type="text" class="form-control text-field-size " id=""
                        placeholder="Former Surnames(if different from above)" name="formername">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix">
                      <input type="date" class="form-control text-field-size " id="" placeholder="Date of Birth"
                        name="dob">
                    </div>
                  </div>
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix">
                      <input type="text" class="form-control text-field-size " id="" placeholder="Nationality"
                        name="nationality">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix">
                      <input type="text" class="form-control text-field-size " id="" placeholder="Address"
                        name="address">
                    </div>
                  </div>
                  <div class="col-sm-12 col-lg-6">
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-6">
                    <div class="input-box-size-fix">
                      <input type="text" class="form-control text-field-size " id="" placeholder="Home Telephone Number"
                        name="startDate">
                    </div>
                  </div>
                  <div class="col-sm-12 col-lg-6">
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-8">
                    <div class="profile-notes">
                      <p>if the application is successful, when are you able to start working for Precedent Surveyors
                        Ltd?</p>
                    </div>
                  </div>
                  <div class="col-sm-12 col-lg-4">
                    <div class="input-box-size-fix">
                      <input type="text" class="form-control text-field-size " id="" placeholder="" name="startDate">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-6 col-sm-6 col-lg-6">
                    <div class="prev-btn float-right">
                      <a href="signup-professionals-profile-2.html" class="btn btn-next" style="width: 164px;">
                        NEXT</a>
                    </div>
              </form>
            </div>
